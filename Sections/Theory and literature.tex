...
\textcite{vukina_1994} is a study that forecasts the price of five different species of salmon in the Tokyo wholesale market. Four state-space models are used to predict and compare the prices by modelling non-stationary time series. When measuring the results according to MSE and MAPE the results the results were found to be quite good. The results were also surprisingly good at predicting the correct direction of the price-movement.
